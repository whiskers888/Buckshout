...
namespace BuckshoutApp.Items
{
    public class Blindfold(GameContext context) : Item(context)
    {
        ...
        public override string Description => "В начале своего хода, цель закроет глаза.\n" +
                                              "Игрок с закрытыми глазами не может использовать предметы, и отличить игроков друг от друга (в том числе и себя).\n" +
                                              "Все игроки отображаются в случайном порядке для игрока в повязке.";
